...
\hypersetup{
  pdftitle={Quarto Paper Templete},
  pdfauthor={Yufei Sun},
...
\begin{frontmatter}
\title{Quarto Paper Templete}
\author[1]{Yufei Sun%
\corref{cor1}%
\fnref{fn1}}
 \ead{sunyf20@mails.tsinghua.edu.cn} 

\affiliation[1]{organization={Tsinghua
University}, addressline={Mingzhai, Qinghua Yuan}, city={Haidian
District}, country={}, postcode={100084}}
...
\begin{keyword}
    ...
    keyword2
\end{keyword}
\end{frontmatter}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, sharp corners, interior hidden]}{\end{tcolorbox}}\fi
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{template_files/figure-pdf/fig-meaningless-1.pdf}
